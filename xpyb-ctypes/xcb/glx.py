...
class GenericError(xcb.Error):
    def __init__(self, parent):
        ...
        count = 0
        (self.bad_value, self.minor_opcode, self.major_opcode,) = unpack_ex('xx2xIHB21x', self, count)
...
class PbufferClobberEvent(xcb.Event):
    def __init__(self, parent):
        ...
        count = 0
        (self.event_type, self.draw_type, self.drawable, self.b_mask, self.aux_buffer, self.x, self.y, self.width, self.height, self.count,) = unpack_ex('xH2xHIIHHHHHH4x', self, count)
...
class MakeCurrentReply(xcb.Reply):
    def __init__(self, parent):
        ...
        count = 0
        (self.context_tag,) = unpack_ex('xx2x4xI20x', self, count)
...
class IsDirectReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.is_direct,) = unpack_ex('xx2x4xB23x', self, count)
...
class GC:
    ...
    GL_TEXTURE_BIT = (1 << 18)
    GL_SCISSOR_BIT = (1 << 19)
    GL_ALL_ATTRIB_BITS = 0x000ffffff
...
class GetVisualConfigsReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.num_visuals, self.num_properties,) = unpack_ex('xx2x4xII16x', self, count)
        count += 32
...
class VendorPrivateWithReplyReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.retval,) = unpack_ex('xx2x4xI', self, count)
        count += 12
...
class QueryExtensionsStringReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n,) = unpack_ex('xx2x4x4xI16x', self, count)
...
class QueryServerStringReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.str_len,) = unpack_ex('xx2x4x4xI16x', self, count)
        count += 32
...
class GetFBConfigsReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.num_FB_configs, self.num_properties,) = unpack_ex('xx2x4xII16x', self, count)
        count += 32
        self.property_list = xcb.List(self, count, self.length, 'I', 4)
...
class QueryContextReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.num_attribs,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
...
class GenListsReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.ret_val,) = unpack_ex('xx2x4xI', self, count)
...
class RenderModeReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.ret_val, self.n, self.new_mode,) = unpack_ex('xx2x4xIII12x', self, count)
        count += 32
...
class GetBooleanvReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n, self.datum,) = unpack_ex('xx2x4x4xIB15x', self, count)
        count += 32
...
class GetDoublevReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n, self.datum,) = unpack_ex('xx2x4x4xId8x', self, count)
        count += 32
...
class GetErrorReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.error,) = unpack_ex('xx2x4xi', self, count)
...
class GetFloatvReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n, self.datum,) = unpack_ex('xx2x4x4xIf12x', self, count)
        count += 32
...
class GetIntegervReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n, self.datum,) = unpack_ex('xx2x4x4xIi12x', self, count)
        count += 32
        self.data = xcb.List(self, count, self.n, 'i', 4)
...
class GetPixelMapusvReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.n, self.datum,) = unpack_ex('xx2x4x4xIH16x', self, count)
        count += 34
...
class GetTexImageReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.width, self.height, self.depth,) = unpack_ex('xx2x4x8xiii4x', self, count)
        count += 32
        self.data = xcb.List(self, count, (self.length * 4), 'B', 1)
...
class AreTexturesResidentReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.ret_val,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
        self.data = xcb.List(self, count, (self.length * 4), 'B', 1)
...
class GetColorTableReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.width,) = unpack_ex('xx2x4x8xi12x', self, count)
        count += 32
        self.data = xcb.List(self, count, (self.length * 4), 'B', 1)
...
class GetConvolutionFilterReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.width, self.height,) = unpack_ex('xx2x4x8xii8x', self, count)
        count += 32
        self.data = xcb.List(self, count, (self.length * 4), 'B', 1)
...
class GetSeparableFilterReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.row_w, self.col_h,) = unpack_ex('xx2x4x8xii8x', self, count)
        count += 32
...
class GetCompressedTexImageARBReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.size,) = unpack_ex('xx2x4x8xi12x', self, count)
        count += 32
        self.data = xcb.List(self, count, (self.length * 4), 'B', 1)
