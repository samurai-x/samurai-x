...
class DrmClipRect(xcb.Struct):
    def __init__(self, parent, offset, size):
        ...
        count = 0
        (self.x1, self.y1, self.x2, self.x3,) = unpack_ex('hhhh', self, count)
...
class QueryVersionReply(xcb.Reply):
    def __init__(self, parent):
        ...
        count = 0
        (self.dri_major_version, self.dri_minor_version, self.dri_minor_patch,) = unpack_ex('xx2x4xHHI', self, count)
...
class QueryDirectRenderingCapableReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.is_capable,) = unpack_ex('xx2x4xB', self, count)
...
class OpenConnectionReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.drm_client_key_low, self.drm_client_key_high, self.sarea_handle_low, self.sarea_handle_high, self.bus_id_len,) = unpack_ex('xx2x4xIIIII12x', self, count)
        count += 40
...
class GetClientDriverNameReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.client_driver_major_version, self.client_driver_minor_version, self.client_driver_patch_version, self.client_driver_name_len,) = unpack_ex('xx2x4xIIII8x', self, count)
        count += 32
...
class CreateContextReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.hw_context,) = unpack_ex('xx2x4xI', self, count)
...
class CreateDrawableReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.hw_drawable_handle,) = unpack_ex('xx2x4xI', self, count)
...
class GetDrawableInfoReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.drawable_table_index, self.drawable_table_stamp, self.drawable_origin_X, self.drawable_origin_Y, self.drawable_size_W, self.drawable_size_H, self.num_clip_rects,) = unpack_ex('xx2x4xIIhhhhI4x', self, count)
        count += 32
...
class GetDeviceInfoReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.framebuffer_handle_low, self.framebuffer_handle_high, self.framebuffer_origin_offset, self.framebuffer_size, self.framebuffer_stride, self.device_private_size,) = unpack_ex('xx2x4xIIIIII', self, count)
        count += 32
...
class AuthConnectionReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.authenticated,) = unpack_ex('xx2x4xI', self, count)
