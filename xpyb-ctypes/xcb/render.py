...
class DIRECTFORMAT(xcb.Struct):
    def __init__(self, parent, offset, size):
        ...
        count = 0
        (self.red_shift, self.red_mask, self.green_shift, self.green_mask, self.blue_shift, self.blue_mask, self.alpha_shift, self.alpha_mask,) = unpack_ex('HHHHHHHH', self, count)

class PICTFORMINFO(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.id, self.type, self.depth,) = unpack_ex('IBB2x', self, count)
        count += 8
        self.direct = DIRECTFORMAT(self, count, 16)
        count += 16
        count += xcb.type_pad(4, count)
        (self.colormap,) = unpack_ex('I', self, count)

class PICTVISUAL(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.visual, self.format,) = unpack_ex('II', self, count)

class PICTDEPTH(xcb.Struct):
    def __init__(self, parent, offset):
        xcb.Struct.__init__(self, parent, offset)
        count = 0
        (self.depth, self.num_visuals,) = unpack_ex('BxH4x', self, count)
        count += 8
...
class PICTSCREEN(xcb.Struct):
    def __init__(self, parent, offset):
        xcb.Struct.__init__(self, parent, offset)
        count = 0
        (self.num_depths, self.fallback,) = unpack_ex('II', self, count)
        count += 8
...
class INDEXVALUE(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.pixel, self.red, self.green, self.blue, self.alpha,) = unpack_ex('IHHHH', self, count)

class COLOR(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.red, self.green, self.blue, self.alpha,) = unpack_ex('HHHH', self, count)

class POINTFIX(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.x, self.y,) = unpack_ex('ii', self, count)
...
class TRAPEZOID(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.top, self.bottom,) = unpack_ex('ii', self, count)
        count += 8
...
class GLYPHINFO(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.width, self.height, self.x, self.y, self.x_off, self.y_off,) = unpack_ex('HHhhhh', self, count)
...
class QueryPictIndexValuesReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.num_values,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
...
class TRANSFORM(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.matrix11, self.matrix12, self.matrix13, self.matrix21, self.matrix22, self.matrix23, self.matrix31, self.matrix32, self.matrix33,) = unpack_ex('iiiiiiiii', self, count)
...
class QueryFiltersReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.num_aliases, self.num_filters,) = unpack_ex('xx2x4xII16x', self, count)
        count += 32
...
class ANIMCURSORELT(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.cursor, self.delay,) = unpack_ex('II', self, count)

class SPANFIX(xcb.Struct):
    def __init__(self, parent, offset, size):
        xcb.Struct.__init__(self, parent, offset, size)
        count = 0
        (self.l, self.r, self.y,) = unpack_ex('iii', self, count)
...
class renderExtension(xcb.Extension):
    ...
    def SetPictureFilterChecked(self, picture, filter_len, filter, values_len, values):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xIH', picture, filter_len))
    ...
    def CreateLinearGradientChecked(self, picture, p1, p2, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
    ...
    def CreateLinearGradient(self, picture, p1, p2, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
        for elt in xcb.Iterator(p1, 2, 'p1', False):
            buf.write(pack('ii', *elt))
    ...
    def CreateRadialGradientChecked(self, picture, inner, outer, inner_radius, outer_radius, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
    ...
    def CreateRadialGradient(self, picture, inner, outer, inner_radius, outer_radius, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
        for elt in xcb.Iterator(inner, 2, 'inner', False):
            buf.write(pack('ii', *elt))
    ...
    def CreateConicalGradientChecked(self, picture, center, angle, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
    ...
    def CreateConicalGradient(self, picture, center, angle, num_stops):
        buf = cStringIO.StringIO()
        buf.write(pack('xx2xI', picture))
        for elt in xcb.Iterator(center, 2, 'center', False):
            buf.write(pack('ii', *elt))
