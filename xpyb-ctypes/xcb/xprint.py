...
class PRINTER(xcb.Struct):
    def __init__(self, parent, offset):
        ...
        count = 0
        (self.nameLen,) = unpack_ex('I', self, count)
        count += 4
        self.name = xcb.List(self, count, self.nameLen, 'b', 1)
        count += len(self.name.buf())
        (self.descLen,) = unpack_ex('I', self, count)
        count += 4
...
class PrintQueryVersionReply(xcb.Reply):
    def __init__(self, parent):
        ...
        count = 0
        (self.major_version, self.minor_version,) = unpack_ex('xx2x4xHH', self, count)
...
class PrintGetPrinterListReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.listCount,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
...
class PrintGetContextReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.context,) = unpack_ex('xx2x4xI', self, count)
...
class PrintGetScreenOfContextReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.root,) = unpack_ex('xx2x4xI', self, count)
...
class PrintGetDocumentDataReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.status_code, self.finished_flag, self.dataLen,) = unpack_ex('xx2x4xIII12x', self, count)
        count += 32
...
class PrintGetAttributesReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.stringLen, self.attributes,) = unpack_ex('xx2x4xI20xb', self, count)
...
class PrintGetOneAttributesReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.valueLen,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
...
class PrintGetPageDimensionsReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.width, self.height, self.offset_x, self.offset_y, self.reproducible_width, self.reproducible_height,) = unpack_ex('xx2x4xHHHHHH', self, count)
...
class PrintSetImageResolutionReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.status, self.previous_resolutions,) = unpack_ex('xB2x4xH', self, count)
...
class PrintGetImageResolutionReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.image_resolution,) = unpack_ex('xx2x4xH', self, count)

class NotifyEvent(xcb.Event):
    def __init__(self, parent):
        xcb.Event.__init__(self, parent)
        count = 0
        (self.detail, self.context, self.cancel,) = unpack_ex('xB2xIB', self, count)

class AttributNotifyEvent(xcb.Event):
    def __init__(self, parent):
        xcb.Event.__init__(self, parent)
        count = 0
        (self.detail, self.context,) = unpack_ex('xB2xI', self, count)
