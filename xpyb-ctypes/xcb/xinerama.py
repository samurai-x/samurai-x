...
class ScreenInfo(xcb.Struct):
    def __init__(self, parent, offset, size):
        ...
        count = 0
        (self.x_org, self.y_org, self.width, self.height,) = unpack_ex('hhHH', self, count)
...
class GetStateReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.state, self.window,) = unpack_ex('xB2x4xI', self, count)
...
class GetScreenCountReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.screen_count, self.window,) = unpack_ex('xB2x4xI', self, count)
...
class GetScreenSizeReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.width, self.height, self.window, self.screen,) = unpack_ex('xx2x4xIIII', self, count)
...
class IsActiveReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.state,) = unpack_ex('xx2x4xI', self, count)
...
class QueryScreensReply(xcb.Reply):
    def __init__(self, parent):
        xcb.Reply.__init__(self, parent)
        count = 0
        (self.number,) = unpack_ex('xx2x4xI20x', self, count)
        count += 32
