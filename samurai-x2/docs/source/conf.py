# -*- coding: utf-8 -*-
#
# samurai-x2 documentation build configuration file, created by
# sphinx-quickstart on Mon Feb  9 01:39:39 2009.
#
...
project = u'samurai-x2'
copyright = u'2008-2009, samurai-x.org'
...
html_theme_options = {
    ...
    "sidebarlinkcolor": "#600000",
    "footerbgcolor": "#cccccc",
    "headtextcolor": "#600000",
    "linkcolor": "#600000",
}
...
htmlhelp_basename = 'samurai-x2doc'
...
latex_documents = [
  ('index', 'samurai-x2.tex', ur'samurai-x2 Documentation',
   ur'samurai-x.org', 'manual'),
]
